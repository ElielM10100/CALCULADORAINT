...
#                         f"Bem vindo, {nome}")
#     # Como apagar o texto de um campo
...
# # Como alterar o título da janela
# janela.title("Infinity school")
#
# # Como criar um label
...
# txt_nome = Entry(janela, font="Tahoma 14",
#                  width=25)
...
#
# # Função que mantém a janela no S.O.
# janela.mainloop()
# ----------------- calculadora.py -------------------
...
janela = Tk()
janela.title("BICHO QUE CALCULA")
